...
public final class ReflectionHelper {
    ...
    public static<T> Field getField(Class<T> type, String name) {
        try {
    ...
    public static<T> Method getMethodByName(T object, String name) {
        return getMethodByName(object, name, null);
    }

    public static<T> Method getMethodByName(T object, String name, Object[] args) {
        return getMethodByName(object.getClass(), name, args);
    }

    public static<T> Method getMethodByName(Class<T> clazz, String name) {
        return getMethodByName(clazz, name, null);
    }

    public static<T> Method getMethodByName(Class<T> clazz, String name, Object[] args) {
